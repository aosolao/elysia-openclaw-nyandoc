...
| 人群 | 主模型 | 备用 | 超时 |
|---|---|---|---|
| 国内省心 | doubao/ark-code-latest | bailian/qwen3.7-plus | 300s |
| 追求质量 | anthropic/claude-sonnet-4 | openai/gpt-4o | 300s |
| 纯本地隐私 | ollama/qwen2.5 | （无） | 600s |
| 极致省钱 | bailian/qwen3.6-flash | doubao/ark-code-latest | 300s |
